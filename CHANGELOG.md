...
### Fixed
- Fix issue with rating submission on touch devices after marking playground visited
...
### Fixed
- Try to fix optimistic visit state update on rating change

## [0.22.2] - 2025-10-19

### Changed
- Improve popup sizing on small screens
...
### Changed
- Make playground popup prettier
...
### Added
- Search Google Maps button for iOS

### Fixed
- Improved visit and rating handling
