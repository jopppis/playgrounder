    ...
    <Box height="100%" display="flex" flexDirection="column" overflow="hidden">
      ...
      <Box flex="1 1 auto" overflowY="auto" px={4} py={4} minHeight={0}>
          ...
          <GridItem>
            <Box p={4} borderWidth="1px" borderColor="brand.200" borderRadius="md" h="100%">
              <Heading size="md" mb={4} color="brand.900">
                {t('admin.proposals.proposalDetails')}
              </Heading>
              ...
              <Flex direction="column" gap={3}>
                ...
                <Flex justify="space-between">
                  ...
                  <Text
                    color={getStatusColor(
                      proposal.edit?.reverted_at ? 'reverted' : proposal.status,
                    )}
                  >
                    {t(
                      `admin.proposals.status.${proposal.edit?.reverted_at ? 'reverted' : proposal.status}`,
                    )}
                  </Text>
                </Flex>
                ...
                <Flex justify="space-between">
                  ...
                  <Text color={getProposalTypeColor()}>{getProposalType()}</Text>
                </Flex>

                {proposal.delete_playground && (
                  <Flex justify="space-between">
                    <Text fontWeight="bold" color="gray.700">
                      {t('admin.proposals.deleteRequest')}
                    </Text>
                ...
                <Box>
                  <Text fontWeight="bold" mb={1} color="gray.700">
                    {t('admin.proposals.reason')}
                  </Text>
                  <Box p={2} bg="gray.50" borderRadius="md">
                    <Text color="gray.700">
                      {proposal.reason || t('admin.proposals.noReasonProvided')}
                    </Text>
                  </Box>
                </Box>
              </Flex>
        ...
        <Box mt={6} p={4} borderWidth="1px" borderColor="brand.200" borderRadius="md" mb={4}>
          <Heading size="md" mb={4} color="brand.900">
            {t('admin.proposals.proposedChanges')}
          </Heading>
          ...
          {proposal.status === 'pending' ? (
            <Box>
              {proposal.proposed_name !== null && proposal.playground_id && (
                <Box mb={4} p={4} borderWidth="1px" borderColor="brand.200" borderRadius="md">
                  <Heading size="sm" mb={2} color="brand.900">
                    {t('playground.name')}
                  </Heading>
                  <Grid templateColumns="1fr 1fr" gap={4}>
                    <Box p={3} bg="gray.50" borderRadius="md">
                      <Text fontWeight="bold" mb={1} color="gray.700">
                        {t('admin.proposals.current')}
                      </Text>
                      <Text color="gray.700">
                        {proposal.playground?.name || t('playground.unnamed')}
                      </Text>
                    ...
                    <Box
                      p={3}
                      bg={getProposalStatusBg(proposal.status, Boolean(proposal.edit?.reverted_at))}
                      borderRadius="md"
                    >
                      <Text fontWeight="bold" mb={1} color="gray.700">
                        {t('admin.proposals.proposed')}
                      </Text>
              ...
              {proposal.delete_playground && (
                ...
                >
                  <Heading size="sm" mb={2} color="red.700">
                    {t('admin.proposals.deletionWarning')}
                  </Heading>
            ...
            <Flex direction="column" gap={4}>
              ...
              <Box mb={4} p={4} borderWidth="1px" borderColor="brand.200" borderRadius="md">
                <Text fontWeight="bold" mb={1} color="gray.700">
                  {t('admin.proposals.decision')}
                </Text>
                <Box
                  p={3}
                  bg={getProposalStatusBg(
                    proposal.edit?.reverted_at ? 'reverted' : proposal.status,
                    false,
                  )}
                  borderRadius="md"
