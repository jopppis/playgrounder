  ...
  return (
    <Box>
      <Flex justify="space-between" align="center" mb={4}>
        <Heading size="md" color="brand.700">{t('admin.proposals.title')}</Heading>
        <select
          value={statusFilter}
          ...
          <Table.Root>
            <Table.Header>
              <Table.Row bg="brand.50">
                <Table.Cell as="th" color="brand.900" fontWeight="semibold" p={3}>{t('admin.proposals.table.date')}</Table.Cell>
                <Table.Cell as="th" color="brand.900" fontWeight="semibold" p={3}>{t('admin.proposals.table.playground')}</Table.Cell>
                <Table.Cell as="th" color="brand.900" fontWeight="semibold" p={3}>{t('admin.proposals.table.type')}</Table.Cell>
                <Table.Cell as="th" color="brand.900" fontWeight="semibold" p={3}>{t('admin.proposals.table.status')}</Table.Cell>
                <Table.Cell as="th" color="brand.900" fontWeight="semibold" p={3}>{t('admin.proposals.table.actions')}</Table.Cell>
              </Table.Row>
            </Table.Header>
            <Table.Body>
              {filteredProposals.map((proposal) => (
                ...
                >
                  <Table.Cell p={3} color="gray.700">{formatDate(proposal.created_at)}</Table.Cell>
