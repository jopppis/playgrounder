...
export const Heading = createComponent<React.HTMLAttributes<HTMLHeadingElement>>(
  'Heading',
  (props) => <h2 data-testid="heading" {...props} />,
);

// Container component
export const Container = createComponent<React.HTMLAttributes<HTMLDivElement>>(
  'Container',
  (props) => <div data-testid="container" {...props} />,
);
