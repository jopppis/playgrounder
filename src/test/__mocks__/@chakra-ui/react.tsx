...
export const ModalOverlay = createComponent<React.HTMLAttributes<HTMLDivElement>>('ModalOverlay', (props) => <div data-testid="modal-overlay" {...props} />)
...
export const ModalCloseButton = createComponent<React.ButtonHTMLAttributes<HTMLButtonElement>>('ModalCloseButton', (props) => <button data-testid="modal-close" {...props}>×</button>)
...
export const DrawerOverlay = createComponent<React.HTMLAttributes<HTMLDivElement>>('DrawerOverlay', (props) => <div data-testid="drawer-overlay" {...props} />)
export const DrawerContent = createComponent<{
  children?: React.ReactNode;
  [key: string]: unknown;
}>('DrawerContent', ({ children, ...props }) => <div data-testid="drawer-content" {...props}>{children}</div>)
export const DrawerHeader = createComponent<{
  children?: React.ReactNode;
  [key: string]: unknown;
}>('DrawerHeader', ({ children, ...props }) => <div data-testid="drawer-header" {...props}>{children}</div>)
export const DrawerBody = createComponent<{
  children?: React.ReactNode;
  [key: string]: unknown;
}>('DrawerBody', ({ children, ...props }) => <div data-testid="drawer-body" {...props}>{children}</div>)
export const DrawerFooter = createComponent<{
  children?: React.ReactNode;
  [key: string]: unknown;
}>('DrawerFooter', ({ children, ...props }) => <div data-testid="drawer-footer" {...props}>{children}</div>)
export const DrawerCloseButton = createComponent<React.ButtonHTMLAttributes<HTMLButtonElement>>('DrawerCloseButton', (props) => <button data-testid="drawer-close" {...props}>×</button>)
